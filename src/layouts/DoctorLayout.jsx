...
const DoctorLayout = () => {
  ...
  return (
    ...
    // transition-all duration-300 mt-[60px] h-12 shadow-inner"
    // >
    <div
      class="fixed gap-4 w-[calc(100%-40px)] lg:w-[calc(100%-160px)]  
    left-40 lg:left-40 px-0 flex justify-center items-center z-20 
    ...
    >
      ...
      <div className="w-full max-w-full mt-25 h-[100vh]">
        {/* <div
        class="fixed gap-4 w-[calc(100%-40px)] lg:w-[calc(100%-160px)]  
    left-40 lg:left-40 px-0 flex justify-center items-center z-20 
    transition-all duration-300 top-[90px] h-12 shadow-inner"
      > */}
        <Outlet />
      </div>
    </div>
