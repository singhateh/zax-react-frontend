...
const InstructorPaymentForm = ({ formData, setFormData, venueOptions, instructorOptions, reportTypeOptions,
    ...
    return (
        <div className="max-w-7xl mx-auto px1-4">
            ...
            <div className="bg-indigo-900 text-white text-sm px-4 py-3 mb-6 rounded shadow">
                Please Select the Instructor and select the Type of the Report required to set the payment terms.
            </div>
