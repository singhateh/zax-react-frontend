        ...
        <div className="container1 mx-auto p-4 mt-20">
            ...
            <div className="bg-white p-4 rounded-lg shadow-md border border-gray-200 mb-6">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="text-md font-semibold">Filter DNA</h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <DateField
                        ...
                        onChange={(date) => setFilters(prev => ({ ...prev, appointmentDate: date }))}
                    />
                    <DateField
                        label="Appointment Date"
                        name="appointmentDate"
            ...
            <div className="bg-white p-4 rounded-lg shadow-md border border-gray-200">
                <h2 className="text-2xl font-semibold text-gray-800 mb-6">DNA List</h2>
                ...
                {clinics.length === 0 ? (
                    <div className="flex flex-col items-center justify-center text-center py-12 text-gray-500">
                        ...
                        <p className="text-sm">No Dna found. Adjust filters or try again later.</p>
                    </div>
                ) : (
